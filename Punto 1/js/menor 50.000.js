const array_concursantes = [
    { nombre: "Delantal", imagen: "img/Delantal.png" },
    { nombre: "Porta documentos", imagen: "img/porta documentos.png" },
    { nombre: "Llaveros", imagen: "img/Llaveros.png" },
    { nombre: "Esferos", imagen: "img/esferos.png" },
    { nombre: "Manillas", imagen: "img/manillas.png" },
    { nombre: "Mangas", imagen: "img/mangas.png" },
    { nombre: "Protector de cuello", imagen: "img/protector de cuello.png" },
    { nombre: "Termos", imagen: "img/termos.png" },
    { nombre: "Calibrador de aire", imagen: "img/calibrador de aire.png" },
    { nombre: "Cartuchera", imagen: "img/cartuchera.png" },
    { nombre: "Pie de rey", imagen: "img/pie de rey.png" },
    { nombre: "Impermeable bolsa", imagen: "img/IMPERMEABLE BOLSA.png" },  
  ];
